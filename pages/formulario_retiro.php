...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $visor_imposibilidad = ($medidor_retirado === 'SI') ? $_POST['visor_imposibilidad'] : null;
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p><strong>Usuario Reclamante:</strong> <?= htmlspecialchars($orden['usuario_reclamante']) ?></p>
                ...
                <div class="card-body">
                    ...
                    <div id="campos_retiro">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" step="0.001" class="form-control" id="lectura_m3" 
                                   name="lectura_m3" placeholder="Ej: 125.500">
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-text" id="obs_help" style="display: none;">
                            <strong class="text-danger">Obligatorio:</strong> Indique el motivo por el cual no se retiró el medidor
                        </div>
                    </div>

                    <!-- FOTO DE IMPOSIBILIDAD (solo si NO se retiró) -->
                    <div id="campo_foto" style="display: none;">
                        <div class="section-title">
                            <i class="bi bi-camera"></i> FOTO DE IMPOSIBILIDAD
                        </div>
                        <div class="mb-4">
                            <input type="file" class="form-control" id="foto_imposibilidad" 
                                   name="foto_imposibilidad" accept="image/*">
                            <div class="form-text">Adjunte una foto que demuestre la imposibilidad de retiro</div>
                        </div>
                    </div>
        ...
        function toggleFields() {
            ...
            if (retirado) {
                if (retirado.value === 'SI') {
                    ...
                    // Deshabilitar campos de NO retiro
                    document.getElementById('foto_imposibilidad').removeAttribute('required');
                } else {
                    camposRetiro.style.display = 'none';
                    campoFoto.style.display = 'block';
                    obsHelp.style.display = 'block';
                    
                    // Hacer obligatorio el motivo en observación
